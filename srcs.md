...
未来可能会基于自己的体验，对一些文章进行修改和合并。

一些文章可能会消失，或者改变标题，这些我无法做到实时改变。

一些文章可能会失去时效性，注意文章时间。

> **文章内的任何关于政治的观点都与本博客无关，本博客只关心技术。**
...
- [oatpp/oatpp —— 一个C++网络框架](https://github.com/oatpp/oatpp)
...
- [GNU](https://www.gnu.org/doc/doc.html)
...
- [Milap Neupane Blog](https://milapneupane.com.np/)
...
- [李炎恢 HTML CSS JavaScript PHP Bootstrap 教程](https://wizardforcel.gitbooks.io/liyanhui-tutorials/content/index.html)
- [Interview——IT 行业应试学知识库](https://interview.apachecn.org/#/)
- [AI learning](https://ailearning.apachecn.org/#/)
- [跟我一起写Makefile](https://seisman.github.io/how-to-write-makefile/overview.html)
- [Learn VIM](https://dofy.gitbook.io/learn-vim/)
- [The Stacks project](https://stacks.math.columbia.edu/)
- [Solutions to Introduction to Algorithms Third Edition](https://walkccc.me/CLRS/)
- [Linux 安全渗透教程](https://wizardforcel.gitbooks.io/daxueba-kali-linux-tutorial/content/index.html)
- [Crafting Interpreters](https://craftinginterpreters.com/)
- [Linux C API 参考手册](https://wizardforcel.gitbooks.io/linux-c-api-ref/content/index.html)
- [Go语言101](https://gfw.go101.org/article/101.html)
- [Python中文指南](https://python.iswbm.com/)
- [LEARN C++](https://www.learncpp.com/)
- [GCC-Inline-Assembly-HOWTO](https://www.ibiblio.org/gferg/ldp/GCC-Inline-Assembly-HOWTO.html)
- [Natural Language Processing with Python](https://www.nltk.org/book/)
- [Michael Kerrisk](https://www.man7.org/)
- [Detailed ToC](https://pubs.opengroup.org/onlinepubs/9699919799/functions/contents.html)
...
- [voidcanvas](https://www.voidcanvas.com/)
...
- [MS-DOS Debug Commands](https://montcs.bloomu.edu/Information/LowLevel/DOS-Debug.html)
- [mysql++安装、使用详解、编程Demo](https://blog.csdn.net/liangwenhao1108/article/details/112300204)
- [RegexOne: Learn Regular Expressions with simple, interactive exercises.](https://regexone.com/)
- [正态分布（高斯分布）、Q函数、误差函数、互补误差函数](https://www.cnblogs.com/htj10/p/8621771.html)
...
- [我做了个实验！](https://mp.weixin.qq.com/s/lGs5IdU7gtgayiI2Lf3XlA)
